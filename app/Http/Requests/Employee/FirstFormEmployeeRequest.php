...
class FirstFormEmployeeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'no_tlpn' => 'required|string|min:10|max:20|unique:employee_personal_informations,no_tlpn',
            ...
            'foto_profil' => ['required', File::types(['jpg','jpeg','png'])->max(5 * 1024),],

            'nik' => 'required|digits:16|unique:employee_confidential_informations,nik',
            'no_tlpn_darurat' => 'required|string|min:10|max:20',
            'nama_kontak_darurat' => 'required|string',
            'status_kontak_darurat' => 'required|string',
            'foto_ktp' => ['required', File::types(['jpg','jpeg','png'])->max(5 * 1024),],
            'foto_kk' => ['required', File::types(['jpg','jpeg','png'])->max(5 * 1024),],
